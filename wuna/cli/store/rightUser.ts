...
export const { updateRightUserCardsNumber, incrementRightUserCardsNumber, decrementRightUserCardsNumber, updateRightUserAvatarId, updateRightUserSeatNumber } = rightUserSlice.actions
