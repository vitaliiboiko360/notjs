...
export const { updateTopUserCardsNumber, incrementTopUserCardsNumber, decrementTopUserCardsNumber, updateTopUserAvatarId, updateTopUserSeatNumber } = topUserSlice.actions
